  ...
  var Qa = "IN_PROGRESS",
      ...
      ss = function(e) {
          ...
          return o(t, [{
              ...
              key: "addLetter",
              value: function(e) {
                  this.gameStatus === Qa && (this.canInput && (this.tileIndex >= WORD_LENGTH || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
              }
          }, {
              key: "removeLetter",
              value: function() {
              ...
              value: function() {
                  if (this.gameStatus === Qa && this.canInput) {
                      if (WORD_LENGTH !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Non abbastanza lettere");
                      this.evaluateRow()
                  }
              }
          }, {
              ...
              value: function() {
                  var e = this.shadowRoot.querySelector("#board-container"),
                      a = Math.min(Math.floor(e.clientHeight * (WORD_LENGTH / 6)), 350),
                      s = 6 * Math.floor(a / WORD_LENGTH);
              ...
              value: function() {
                  ...
                  for (var a = 0; a < 6; a++) {
                      ...
                      s.setAttribute("letters", this.boardState[a]), s.setAttribute("length", WORD_LENGTH), this.evaluations[a] && (s.evaluation = this.evaluations[a]), this.$board.appendChild(s)
                  }
