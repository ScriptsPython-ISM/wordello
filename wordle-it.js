this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Aa = ["petto", "cuoco", "danno", "zaino", "nonno", "campo", "carne", "nonna", "visto", "forno", "dieta", "della", "ditta", "acqua", "leggo", "liceo", "pollo", "citta", "morti", "sport", "terra", "letto", "preso", "corpo", "ferie", "treno", "jeans", "spero", "detto", "carta", "burro", "tanti", "tanta", "nonni", "festa", "padre", "zuppa", "tante", "mezzi", "fuoco", "utile", "vasca", "scemo", "caffe", "gioco", "madre", "basso", "denti", "posso", "succo", "dolce", "parla", "costa", "aiuta", "heels", "paese", "bagno", "testa", "stato", "latte", "scarf", "pizza", "tosse", "pelle", "collo", "dress", "amici", "primo", "pasta", "tanto", "aereo", "pesce", "parco", "nella", "fanno", "posto", "hanno", "gente", "piedi", "buffo", "miele", "birra", "soldi", "stata", "metro", "porto", "light", "capoa", "mensa", "tight", "manzo", "skirt", "forma", "tetto", "socks", "molto", "scale", "sedia", "museo", "pigro", "pazzo", "tempo", "russo", "watch", "leale", "luogo", "piano", "torre", "boots", "mamma", "abito", "unico", "sento", "tende", "piede", "serie", "ponte", "bocca", "fatto", "polso", "shirt", "tutti", "mento", "shoes", "banca", "stare", "libro", "piace", "bello", "occhi", "senso", "cuore", "santo", "festa", "pieno", "sarei", "volte", "gamba", "short", "pista", "loose", "torta", "trama", "magro", "guida", "esame"],
      La = [],
      Ta = "present",
      Ia = "correct",
      Ca = "absent";
