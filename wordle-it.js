this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Aa = ["abito","petto","hanno","cuoco","cuoca","danno","danni","zaino","zaini","campo","campi","carne","carni","nonna","nonno","nonni","nonne","visto","forno","forni","dieta","diete","della","delle","ditta","ditte","acqua","acque","leggo","legge","leggi","liceo","licei","pollo","polli","citta","citte","morti","sport","terra","terre","letto","letti","preso","corpo","corpi","ferie","treno","treni","jeans","spero","detto","carta","carte","burro","burri","tanti","tanta","tanto","tante","festa","feste","padre","padri","zuppa","zuppe","mezzi","fuoco","utile","vasca","scemo","scema","sceme","scemi","caffe","gioco","gioca","madre","madri","basso","bassa","bassi","basse","denti","posso","possa","possi","succo","dolce","dolci","parla","parlo","parli","costa","coste","aiuta","aiuto","paese","paesi","bagno","bagni","testa","teste","stato","latte","latti","pizza","tosse","pelle","pelli","collo","colli","amici","amico","amica","primo","prima","pasta","aereo","aerei","pesce","pesci","parco","nella","fanno","posto","posti","gente","piedi","piede","buffo","buffa","buffe","buffi","miele","birra","birre","soldi","stata","metro","metri","porto","porti","mensa","manzo","forma","forme","tetto","tetti","molto","molti","molta","molte","scale","scala","sedia","sedie","museo","musei","pigro","pigra","pigri","pigre","pazzo","pazza","pazzi","pazze","tempo","tempi","russo","russi","russa","russe","leale","leali","luogo","piano","piani","torre","torri","mamma","mamme","unico","unica","unici","sento","sente","senti","tende","tenda","serie","ponte","ponti","bocca","bocce","fatto","polso","polsi","tutti","tutto","mento","menti","banca","stare","libro","libri","piace","bello","bella","belli","belle","occhi","senso","sensi","cuore","cuori","santo","santi","pieno","sarei","volte","volta","gamba","gambe","pista","piste","torta","torte","trama","trame","magro","magri","magra","magre","guida","guide","esame","esami","gonna","marca","largo","larga","felpa","felpe","cuoio","pelle","corto","corti","corte","corta","lungo","lunga"],
      La = [],
      Ta = "present",
      Ia = "correct",
      Ca = "absent";
