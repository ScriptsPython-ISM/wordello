this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Aa = ["spero", "corta", "primo", "danno", "unico", "dolci", "carni", "aiuto", "piste", "unica", "piace", "guide", "campo", "soldi", "stata", "nonne", "esame", "trama", "fuoco", "piano", "bassa", "buffo", "sensi", "felpa", "carne", "leggo", "sedie", "mamma", "larga", "pigre", "pizza", "largo", "tanta", "mento", "fatto", "sarei", "piede", "parco", "pigri", "zaini", "carte", "buffi", "miele", "gioca", "cuori", "tutto", "gambe", "colli", "magro", "gonna", "birra", "marca", "basso", "prima", "gamba", "scemi", "porto", "letto", "banca", "belle", "testa", "ditta", "hanno", "santi", "tenda", "belli", "citta", "gente", "amico", "burro", "torri", "mamme", "libro", "russi", "russa", "letti", "bocce", "parli", "treni", "birre", "buffe", "basse", "leali", "bocca", "terre", "parla", "bagni", "tante", "stare", "luogo", "stato", "nonno", "trame", "museo", "polso", "cuore", "ponti", "tempo", "latti", "nella", "pollo", "utile", "ditte", "tosse", "legge", "pelle", "morti", "volta", "parlo", "zuppa", "aereo", "leale", "paese", "piedi", "madre", "madri", "mensa", "musei", "carta", "cuoco", "polsi", "menti", "pelle", "serie", "senso", "gioco", "forno", "caffe", "ponte", "leggi", "sente", "corpi", "posti", "citte", "buffa", "magra", "pesce", "bagno", "sedia", "torre", "sceme", "forma", "lungo", "jeans", "delle", "felpe", "acqua", "zuppe", "coste", "pazzi", "sport", "tempi", "teste", "detto", "preso", "campi", "cuoca", "tende", "abito", "padre", "corte", "metro", "russe", "unici", "festa", "sento", "amici", "della", "molto", "tutti", "aerei", "posso", "scala", "santo", "posto", "pelli", "molte", "forme", "torte", "cuoio", "padri", "visto", "senti", "petto", "pazzo", "tanto", "molta", "forni", "costa", "corti", "pigro", "corto", "pazza", "nonna", "aiuta", "manzo", "possa", "scemo", "mezzi", "metri", "bassi", "burri", "dieta", "polli", "corpo", "pesci", "esami", "bello", "ferie", "lunga", "liceo", "denti", "possi", "feste", "tanti", "vasca", "volte", "paesi", "magri", "collo", "piani", "torta", "danni", "tetto", "latte", "bella", "treno", "fanno", "dolce", "tetti", "porti", "succo", "russo", "acque", "magre", "licei", "pasta", "pieno", "occhi", "libri", "scale", "pista", "nonni", "amica", "molti", "terra", "zaino", "guida", "pazze", "scema", "diete", "pigra"],
      La = [],
      Ta = "present",
      Ia = "correct",
      Ca = "absent";
